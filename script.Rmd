...
+ Anidados porque los niveles del factor son diferentes para cada lote. 

```{r}
load('cemento.Rdata')
```

Cruzar las dos variables y hacer una nueva variable llamado `saco1`usando la combianción de ambas variables
